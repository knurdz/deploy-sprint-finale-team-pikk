...
| T24 |  |  |  |
| T25 |  |  |  |
| T26 | [T26 PR](https://github.com/knurdz/deploy-sprint-finale-team-pikk/pull/36) | .github/workflows/deploy-broken.yml, Actions runs #30198747435 (broken) + #30198775068 (fixed) | Root cause: workflow ran npm ci at repo root and uploaded wrong artifact path (build instead of dist). Fix: added working-directory: team-site and corrected path to team-site/dist. Recovery run succeeded. |
| T27 |  |  |  |
| T28 |  |  |  |
| T29 |  |  |  |
| T30 |  |  |  |
